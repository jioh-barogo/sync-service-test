...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<net.devh.boot.grpc.examples.lib.TestRequest,
      net.devh.boot.grpc.examples.lib.TestResponse> getTestParamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TestParam",
      requestType = net.devh.boot.grpc.examples.lib.TestRequest.class,
      responseType = net.devh.boot.grpc.examples.lib.TestResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<net.devh.boot.grpc.examples.lib.TestRequest,
      net.devh.boot.grpc.examples.lib.TestResponse> getTestParamMethod() {
    io.grpc.MethodDescriptor<net.devh.boot.grpc.examples.lib.TestRequest, net.devh.boot.grpc.examples.lib.TestResponse> getTestParamMethod;
    if ((getTestParamMethod = SimpleGrpc.getTestParamMethod) == null) {
      synchronized (SimpleGrpc.class) {
        if ((getTestParamMethod = SimpleGrpc.getTestParamMethod) == null) {
          SimpleGrpc.getTestParamMethod = getTestParamMethod =
              io.grpc.MethodDescriptor.<net.devh.boot.grpc.examples.lib.TestRequest, net.devh.boot.grpc.examples.lib.TestResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TestParam"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.devh.boot.grpc.examples.lib.TestRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.devh.boot.grpc.examples.lib.TestResponse.getDefaultInstance()))
              .setSchemaDescriptor(new SimpleMethodDescriptorSupplier("TestParam"))
              .build();
        }
      }
    }
    return getTestParamMethod;
  }
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void testParam(net.devh.boot.grpc.examples.lib.TestRequest request,
        io.grpc.stub.StreamObserver<net.devh.boot.grpc.examples.lib.TestResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getTestParamMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                net.devh.boot.grpc.examples.lib.TestRequest,
                net.devh.boot.grpc.examples.lib.TestResponse>(
                  this, METHODID_TEST_PARAM)))
          .build();
    }
  }
  ...
  public static final class SimpleStub extends io.grpc.stub.AbstractAsyncStub<SimpleStub> {
    ...
    public void testParam(net.devh.boot.grpc.examples.lib.TestRequest request,
        io.grpc.stub.StreamObserver<net.devh.boot.grpc.examples.lib.TestResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getTestParamMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
    ...
    /**
     */
    public net.devh.boot.grpc.examples.lib.TestResponse testParam(net.devh.boot.grpc.examples.lib.TestRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getTestParamMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<net.devh.boot.grpc.examples.lib.TestResponse> testParam(
        net.devh.boot.grpc.examples.lib.TestRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getTestParamMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_SAY_HELLO = 0;
  private static final int METHODID_TEST_PARAM = 1;
      ...
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((net.devh.boot.grpc.examples.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<net.devh.boot.grpc.examples.lib.HelloReply>) responseObserver);
          break;
        case METHODID_TEST_PARAM:
          serviceImpl.testParam((net.devh.boot.grpc.examples.lib.TestRequest) request,
              (io.grpc.stub.StreamObserver<net.devh.boot.grpc.examples.lib.TestResponse>) responseObserver);
          break;
        default:
